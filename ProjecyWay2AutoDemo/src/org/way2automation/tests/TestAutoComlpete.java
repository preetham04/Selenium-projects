...
public class TestAutoComlpete extends BaseClass {
	...
	public void validateAccordion() throws InterruptedException
	{
		...
		Thread.sleep(5000);
		AutoComplete acc = new AutoComplete(driver); // call the method for AutoComplete
		acc.AutoCompletePage();
